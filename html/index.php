...
function requireAutoLoader( string $path ) {

    if ( '' === $path || '/' === $path ) {

        throw new \RuntimeException( 'Could not find autoloader in any of the parent directories.' );

    }

    $loader = $path . '/vendor/autoload.php';
    ...
    requireAutoLoader( dirname( $path ) );

}

requireAutoLoader( __DIR__ );
...
$GLOBALS['XHPROF_LIB_ROOT'] = Profiler::getRoot() . '/lib';
